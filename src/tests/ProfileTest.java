...
public class ProfileTest extends BasicTest {
	...
	public void changeProfileImage() throws IOException, InterruptedException {
		...
		sa.assertEquals(nsp.getMessage(), "Profile Image Uploaded Successfully",
				"[Error] Profile Image Uploaded unsuccessful!");

		nsp.WaitNotifDissapear();

		profP.removeImg();

		sa.assertEquals(nsp.getMessage(), "Profile Image Deleted Successfully",
				"[Error] Profile Image Deleted unsuccessful!");
